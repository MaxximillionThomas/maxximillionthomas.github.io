...
function result() {
  ...
  if(document.getElementById("uk").checked) {
    ...
    const temperature =  Math.round(94) + ' stone';

  }

  story.textContent = ; // To correct - Completing the result() function: - https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Scripting/Silly_story_generator
